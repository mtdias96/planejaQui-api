...
ALTER TABLE "pluggy_accounts" ADD COLUMN "transactions_synced_through" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "pluggy_webhook_events" ADD COLUMN "processing_status" text DEFAULT 'pending' NOT NULL;--> statement-breakpoint
ALTER TABLE "pluggy_webhook_events" ADD COLUMN "processed_at" timestamp with time zone;--> statement-breakpoint
